...
public int compareTo(UsuarioTwitter otroUsuario) {

int comparacionPorAmigos = Integer.compare(otroUsuario.amigosEnSistema, this.amigosEnSistema);

if (comparacionPorAmigos != 0) {

return comparacionPorAmigos;

}

return this.screenName.compareTo(otroUsuario.screenName);
