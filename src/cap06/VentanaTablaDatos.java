	...
	public void setDatos( DataSetMunicipios datosMunis ) {
		...
		//if (activado) { //Esto es de prueba
			...
			tablaDatos.setDefaultRenderer( Integer.class, new DefaultTableCellRenderer() {
				...
				// Paso 10:
				private JProgressBar pbHabs = new JProgressBar( 0, 5000000 ) { //Esto es porque querip dibujarla diferent (los valores encima)
				...
				//Barra para la práctica
				private JProgressBar poblacion = new JProgressBar(50000, 5000000) {
					protected void paintComponent(java.awt.Graphics g) { //La modifico a mi gusto
						super.paintComponent(g);
						//g.setColor(Color.red);
						if (getPercentComplete() > 0.1) {
